  ...
  return (
    <div className={styles.main}>
      <p>
        ...
        Duotrigordle and how we use it.
      </p>
      ...
      <p>
        Duotrigordle follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of Duotrigordle.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Duotrigordle, which are sent
      ...
      <p>
        Note that Duotrigordle has no access to or control over these cookies
      ...
      <p>
        Duotrigordle's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Duotrigordle does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Duotrigordle. This policy is not applicable to
